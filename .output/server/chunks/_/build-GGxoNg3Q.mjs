...
function style(node, value, prev) {
  ...
  let v, s;
  for (s in prev) {
    (_a = value[s]) != null ? _a : nodeStyle.removeProperty(s);
    delete prev[s];
  }
  for (s in value) {
    v = value[s];
...
var setupStyleSheet = (nonce, target) => {
  if (!nonce) return;
  if (document.querySelector("#_goober") || (target == null ? void 0 : target.querySelector("#_goober"))) return;
...
var _client, _onlineManager, _queryFlavor, _version, _isMounted, _styleNonce, _shadowDOMTarget, _buttonPosition, _position, _initialIsOpen, _errorTypes, _hideDisabledQueries, _Component, _dispose, _a, _client2, _onlineManager2, _queryFlavor2, _version2, _isMounted2, _styleNonce2, _shadowDOMTarget2, _buttonPosition2, _position2, _initialIsOpen2, _errorTypes2, _hideDisabledQueries2, _onClose, _Component2, _dispose2, _b;
  ...
  mount(el) {
    ...
    const dispose = render(() => {
      ...
      if (__privateGet(this, _Component)) Devtools = __privateGet(this, _Component);
        ...
        Devtools = lazy(() => import('./NCMVHL6D-BsjoQisJ.mjs'));
  ...
  mount(el) {
    ...
    const dispose = render(() => {
      ...
      if (__privateGet(this, _Component2)) Devtools = __privateGet(this, _Component2);
        ...
        Devtools = lazy(() => import('./2AITGKQY-DgLTrnov.mjs'));
...
}, _client2 = new WeakMap(), _onlineManager2 = new WeakMap(), _queryFlavor2 = new WeakMap(), _version2 = new WeakMap(), _isMounted2 = new WeakMap(), _styleNonce2 = new WeakMap(), _shadowDOMTarget2 = new WeakMap(), _buttonPosition2 = new WeakMap(), _position2 = new WeakMap(), _initialIsOpen2 = new WeakMap(), _errorTypes2 = new WeakMap(), _hideDisabledQueries2 = new WeakMap(), _onClose = new WeakMap(), _Component2 = new WeakMap(), _dispose2 = new WeakMap(), _b);

export { $TRACK as $, getMutationStatusColor as A, getQueryStatusColor as B, getQueryStatusColorByLabel as C, displayValue as D, convertRemToPixels as E, For as F, untrack as G, useTransition as H, spread as I, mergeProps as J, createRoot as K, serialize as L, Index as M, updateNestedDataByPath as N, addEventListener as O, Portal as P, stringify as Q, Match as R, Show as S, TanstackQueryDevtools as T, Switch as U, deleteNestedDataByPath as V, splitProps as W, Dynamic as X, createComputed as Y, TanstackQueryDevtoolsPanel as a, createComponent as b, createMemo as c, createContext as d, createSignal as e, createEffect as f, getPreferredColorScheme as g, createRenderEffect as h, insert as i, className as j, clearDelegatedEvents as k, delegateEvents as l, memo as m, onCleanup as n, onMount as o, mutationSortFns as p, on as q, setAttribute as r, sortFns as s, template as t, useContext as u, getSidedProp as v, use as w, createUniqueId as x, batch as y, getQueryStatusLabel as z };
//# sourceMappingURL=build-GGxoNg3Q.mjs.map
